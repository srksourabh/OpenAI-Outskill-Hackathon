...
export default function HomePage() {
  return (
    <main className="bg-surface text-white">
      <section className="mx-auto grid min-h-[calc(100dvh-64px)] w-full max-w-7xl content-center gap-8 px-4 py-10">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)]">
          ...
          Create campaigns, configure agent prompt behavior, monitor system health, capture callback commitments, and export every call outcome with transcript-ready auditability.
            ...
            Sign In
              ...
              <Link className="rounded-md border-2 border-white px-5 py-3 text-sm font-black text-white" href="/campaigns">
          ...
          <div className="rounded-2xl bg-white p-5 text-ink">
            <div className="rounded-2xl border-4 border-surface p-4">
              ...
              <div className="mt-5 grid gap-3">
                {["Upload contacts", "Tune Hindi-first agent", "Start live calls", "Download outcomes"].map((item, index) => (
