  ...
  const startedCalls = await Promise.all(
    nextCalls.map(async (call) => {
      ...
      const answerUrl = buildSignedCallbackUrl("/api/plivo/answer", call.id, {
        ...
        callPurpose: campaign.prompt_config.call_purpose,
        requestType: campaign.prompt_config.request_type,
        assetLabel: campaign.prompt_config.asset_label,
        referenceLabel: campaign.prompt_config.reference_label,
        addressLabel: campaign.prompt_config.address_label,
        confirmationPoints: campaign.prompt_config.confirmation_points.join("\n"),
        collectionPoints: campaign.prompt_config.collection_points.join("\n"),
